	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glRotatef(giroLlanta, 1.0, 0.0, 0.0);
				glRotatef(180, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);	//Tra-Izq
				glPopMatrix();
				...
				glTranslatef(-6, -1, -9.5);
				glRotatef(giroLlanta, 1.0, 0.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);	//Tra-Der
				glPopMatrix();
			...
			glPushMatrix(); //Camino1
				...
				glScalef(130,0.1,7);//camino de adelante
				glDisable(GL_LIGHTING);
			...
			glPushMatrix(); //Camino2
				...
				glScalef(83,0.1,7);//Camino de atras
				glDisable(GL_LIGHTING);
				fig3.prisma_text(text4.GLindex, 0);
				glEnable(GL_LIGHTING);
			glPopMatrix();
